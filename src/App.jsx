    ...
    <>
      ...
      <div className="content">
        <div className="App" ref={containerWidth}>
          ...
          <a href="https://api.whatsapp.com/send?phone=+573207689885&amp;text=Hola%20estoy%20usando%20WhatsApp" target="_blank" rel="noreferrer" className="fixed w-[65px] h-[65px] z-[9] bottom-2 right-2 bg-[#05aa08] rounded-full p-2 flex items-center justify-center border-2 border-white text-white hover:opacity-90 cursor-pointer overflow-hidden"><FontAwesomeIcon size="3x" icon={faWhatsapp}/></a>
