...
const ModalComent = ({activateModalMusic, setactivateModalMusic}) => {
  ...
  return (
    <>
      {activateModalMusic && (
          <div className="fixed w-40 h-[160px] z-10 bg-white right-20 top-16 rounded-lg p-2 shadow-md">
            <p className="text-center text-[14px]">
              Cada vez que recargas la página hay posibilidad que se reproduzca otra canción.
            </p>
            <button
